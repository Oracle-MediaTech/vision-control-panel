...
function patchFrontendConfig(lanIP) {
    const nextConfigPath = path_1.default.join(FRONTEND_DIR, 'next.config.js');
...
`;
    fs_1.default.writeFileSync(nextConfigPath, nextConfig, 'utf-8');
